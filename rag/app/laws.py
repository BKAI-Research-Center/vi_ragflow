...
###
from .chunking_law_by_cuong import main_chunking_law
###
...
###
def docx_custom(filename):
    doc = Document(filename)  # Mở file .docx
    chunks = [para.text for para in doc.paragraphs if para.text.strip()]  # Lấy danh sách các đoạn văn bản
    return chunks
###
