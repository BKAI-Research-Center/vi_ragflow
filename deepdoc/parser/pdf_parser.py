...
if __name__ == "__main__":
    rag_flow_pdf_parser = RAGFlowPdfParser()
    text, tables = rag_flow_pdf_parser(
        r"C:\Users\ADMIN\Code\BKAI\BNV_chatbot\ragflow_deepdoc\image\test.pdf",
        need_image=True,
        zoomin=3,
        return_html=False,
    )

    print(f"[INFO] Parsed text: {text}")
    print(f"[INFO] Parsed tables: {tables}")
